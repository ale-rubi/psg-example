...
#Aqui convertimos todos estos valores en cadenas 
entero = str(1)
flotante = str(1E-3)
hexadecimal = str(0xA)
booleano = str (True)
...
#Ejemplo de una notacion que genera algun tipo de error con string
...
#Indices de una cadena en positivo
...
#Indices de una cadena en negativo
...
#Como seleccionar seccines de una cadena
print ("Slicing")
